...
class FakultasDetailActivity : AppCompatActivity() {
    ...
    private fun pencetEmail(email: String) {
        ...
        mailIntent.putExtra(Intent.EXTRA_SUBJECT, "EMAIL FROM")
        mailIntent.putExtra(Intent.EXTRA_TEXT, "TRY EMAIL")
        startActivity(Intent.createChooser(mailIntent, "PLEASE CHOOSE EMAIL ..."))
